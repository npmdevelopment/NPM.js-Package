...
function listTranslations() {
    console.log(translate("available_language", translations)); // Mensaje de idiomas disponibles
    console.log("es"); // Español
    console.log("en " + translate("en_default", translations)); // Inglés
    console.log("fr " + translate("new_lang", translations)); // Francés
    console.log("de " + translate("new_lang", translations)); // Alemán
    console.log("it " + translate("new_lang", translations)); // Italiano
    console.log("pt " + translate("new_lang", translations)); // Portugués
}
...
const command = args.find(arg => ['--export', '--import', '--create', '--github', '--discord', '-v', '--v', '-version', '--version', 'github.io', 'node-v', "--list-translations"].includes(arg)) || '';
...
if (command === '--export') {
    ...
    console.log("https://github.com/npmjs-file/NPM.js-Package");
} else if (command === '-version' || command === '-v' || command === '--v' || command === '--version') {
    console.log(`Package.NPMjs v${packageJSON.version}`);
} else if (command === 'github.io') {
    console.log(`https://npmjs-file.github.io`);
} else if (command === 'node-v') {
    console.log(`${process.version}`);
} else if (command === '--list-translations') {
    ...
    console.log("node main --github");
    console.log("node main -v");
    console.log("node main github.io");
    console.log(translate("langlist_command", translations));
}
